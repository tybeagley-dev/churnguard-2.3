...
async function backfillSeptemberPartial() {
  console.log('🔄 Starting September 2025 partial backfill (Sept 20-29)...\n');

  const etl = new DailyMetricsETLPostgresNative();
  const results = [];

  // Only backfill failed dates (Sept 20-29)
  const dates = [];
