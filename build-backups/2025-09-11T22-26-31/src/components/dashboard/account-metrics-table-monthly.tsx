...
export default function AccountMetricsTableMonthly() {
  ...
  const { sortedAccounts, paginatedAccounts, totalPages, summaryStats, currentMonthStats, calculatedDeltas, uniqueCSMs, uniqueRiskLevels, uniqueStatuses } = useMemo(() => {
    ...
    return { sortedAccounts, paginatedAccounts, totalPages, summaryStats, currentMonthStats, calculatedDeltas, uniqueCSMs, uniqueRiskLevels, uniqueStatuses };
  }, [accounts, selectedCSMs, selectedRiskLevel, searchQuery, selectedStatus, sortField, sortDirection, currentPage, timePeriod, calculateTrendingRiskLevel]);
