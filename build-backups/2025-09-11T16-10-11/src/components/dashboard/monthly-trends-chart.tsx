        ...
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Legend />
              <defs>
                <pattern id="stripe-high" patternUnits="userSpaceOnUse" width="60" height="60" patternTransform="rotate(45)">
                  <rect width="30" height="60" fill={colors.high_risk} />
                </pattern>
                <pattern id="stripe-medium" patternUnits="userSpaceOnUse" width="60" height="60" patternTransform="rotate(45)">
                  <rect width="30" height="60" fill={colors.medium_risk} />
                </pattern>
                <pattern id="stripe-low" patternUnits="userSpaceOnUse" width="60" height="60" patternTransform="rotate(45)">
                  <rect width="30" height="60" fill={colors.low_risk} />
                </pattern>
              </defs>
              <Bar 
                dataKey="high_risk" 
