        ...
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Legend />
              <defs>
                <pattern id="stripe-high" patternUnits="userSpaceOnUse" width="100" height="100">
                  <path d="M0,100 l100,-100" style={{ stroke: colors.high_risk, strokeWidth: 8 }} />
                </pattern>
                <pattern id="stripe-medium" patternUnits="userSpaceOnUse" width="100" height="100">
                  <path d="M0,100 l100,-100" style={{ stroke: colors.medium_risk, strokeWidth: 8 }} />
                </pattern>
                <pattern id="stripe-low" patternUnits="userSpaceOnUse" width="100" height="100">
                  <path d="M0,100 l100,-100" style={{ stroke: colors.low_risk, strokeWidth: 8 }} />
                </pattern>
              </defs>
              <Bar 
                dataKey="high_risk" 
