        ...
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Legend />
              <defs>
                <pattern id="stripe-high" patternUnits="userSpaceOnUse" width="8" height="8" patternTransform="rotate(45)">
                  <rect width="8" height="8" fill={colors.high_risk} />
                  <rect width="4" height="8" fill="rgba(255,255,255,0.3)" />
                </pattern>
                <pattern id="stripe-medium" patternUnits="userSpaceOnUse" width="8" height="8" patternTransform="rotate(45)">
                  <rect width="8" height="8" fill={colors.medium_risk} />
                  <rect width="4" height="8" fill="rgba(255,255,255,0.3)" />
                </pattern>
                <pattern id="stripe-low" patternUnits="userSpaceOnUse" width="8" height="8" patternTransform="rotate(45)">
